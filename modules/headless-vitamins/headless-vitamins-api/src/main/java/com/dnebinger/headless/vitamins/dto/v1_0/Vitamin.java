...
public class Vitamin implements Serializable {
	...
	public static Vitamin toDTO(String json) {
		return ObjectMapperUtil.readValue(Vitamin.class, json);
	}
	...
	@GraphQLField(description = "The description of the vitamin or mineral.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The group the vitamin or mineral belongs to.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The vitamin or mineral internal ID.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String id;
	...
	@GraphQLField(description = "The vitamin or mineral name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "Risks associated with the vitamin or mineral.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The type of the vitamin or mineral.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Type type;
	...
	@Schema(
		defaultValue = "com.dnebinger.headless.vitamins.dto.v1_0.Vitamin",
		name = "x-class-name"
	)
