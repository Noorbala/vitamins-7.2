 ...
 */
@Generated("")
public class Vitamin implements Cloneable, Serializable {

	public static Vitamin toDTO(String json) {
		return VitaminSerDes.toDTO(json);
	}
	...
	@Override
	public Vitamin clone() throws CloneNotSupportedException {
		return (Vitamin)super.clone();
	}
