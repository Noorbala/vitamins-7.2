...
import com.dnebinger.headless.vitamins.client.problem.Problem;
...
public interface VitaminResource {
	...
	public void deleteVitaminBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteVitaminBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public void putVitaminBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse putVitaminBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public static class VitaminResourceImpl implements VitaminResource {
		...
		public HttpInvoker.HttpResponse deleteVitaminHttpResponse(
			...
			httpInvoker.path("vitaminId", vitaminId);
		...
		public void deleteVitaminBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteVitaminBatchHttpResponse(callbackURL, object);
		...
		public void putVitaminBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse = putVitaminBatchHttpResponse(
				callbackURL, object);
